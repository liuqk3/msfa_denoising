...
def BF_ISO_analysis(k=128):
    ...
    ax.set_xlabel('')
    ax.set_ylabel('')
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_row.png'.format(k), bbox_inches='tight')
    plt.clf()
    ...
    ax.set_xlabel('')
    ax.set_ylabel('')
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_col.png'.format(k), bbox_inches='tight')
    plt.clf()
    ...
    ax.set_xlabel('')
    ax.set_ylabel('')
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_read_gauss.png'.format(k), bbox_inches='tight')        
    plt.clf()
    ...
    # plt.show()
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_read_PPCC.png'.format(k), bbox_inches='tight')        
    plt.clf()
    ...
    # plt.show()
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_read_TL.png'.format(k), bbox_inches='tight')        
    plt.clf()
...
def banding_FFT(frame, k=128):
    ...
    # plt.show() 
    plt.savefig('figure_withcb_cn/BF_analysis/band_{}_FFT.png'.format(k), bbox_inches='tight')        
    plt.clf()
...
if __name__ == '__main__':
    if not os.path.exists('/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/calibration/figure_withcb_cn/BF_analysis'):
        os.makedirs('/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/calibration/figure_withcb_cn/BF_analysis')
    for k in range(25):
        # FF_analysis(k)
        BF_ISO_analysis(k)
