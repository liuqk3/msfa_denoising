...
if __name__ == '__main__':
    ...
    if not os.path.exists('/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/calibration/figure/joint_distribution'):
        os.makedirs('/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/calibration/figure/joint_distribution')


    for k in range(25):

        data_path = join('camera_params', 'band_{}.npy'.format(k))
        # if os.path.exists(data_path):
        #     data = np.load(data_path, allow_pickle=True)
        if False:
            pass
        ...
        params_path = join('camera_params', 'band_{}_params.npy'.format(k))
