...
if __name__ == "__main__":
    ...
    list_dir = '/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/data/dataset_v4/testval.txt'
    save_data = '/home/jiangyuqi/Desktop/HSI_denoising_demosaicing/data/syn_data'

    os.makedirs(save_data, exist_ok=True)

    train_dataset = DataLoaderTrainSynCB(data_dir, list_dir, ratio=10, noisemodel='PgRCBU')
    ...
    for i, data in enumerate(train_dataset):
        ...
        os.makedirs(join(save_data, str(i)), exist_ok=True)
        np.save(join(save_data, str(i), 'noise_all.npy'), noisy)
        np.save(join(save_data, str(i), 'noise_cb.npy'), noisy_cb)