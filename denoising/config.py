...
class Config(object):
    ...
    def __init__(self, config_yaml: str=None, config_override: List[Any] = []):
        ...
        self._C.TRAINING.DATA_DIR = 'data/scene_data_v4'
        self._C.TRAINING.TRAIN_FILE = 'data/dataset_v4/train.txt'
        self._C.TRAINING.VAL_FILE = 'data/dataset_v4/testval.txt'
        ...
        if self._C.DATA == 'syn':
            ...
            # self._C.TRAINING.SAVE_DIR = 'ckpt_trans_competing_network_syn/sert2'
            self._C.TRAINING.SAVE_DIR = 'exp/unet_decoupled_posemb_plus_25c_1'
            # self._C.TRAINING.SAVE_DIR = 'checkpoints/main_ckpt/checkpoints_synmix_PgRCBU_final_9'
            # self._C.TRAINING.SAVE_DIR = 'ckpt_trans_competing_network_syn/SCUNet'
        else:
