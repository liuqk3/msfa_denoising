...
class REDNet30(nn.Module):
    def __init__(self, num_layers=15, num_features=64, channels=3):
        ...
        conv_layers.append(nn.Sequential(nn.Conv2d(channels, num_features, kernel_size=3, stride=2, padding=1),
                                         nn.ReLU(inplace=True)))
        for i in range(num_layers - 1):
            conv_layers.append(nn.Sequential(nn.Conv2d(num_features, num_features, kernel_size=3, padding=1),
                                             nn.ReLU(inplace=True)))
        ...
        for i in range(num_layers - 1):
            deconv_layers.append(nn.Sequential(nn.ConvTranspose2d(num_features, num_features, kernel_size=3, padding=1),
                                               nn.ReLU(inplace=True)))
        deconv_layers.append(nn.ConvTranspose2d(num_features, channels, kernel_size=3, stride=2, padding=1, output_padding=1))
...
class REDNet30_LR(nn.Module):
    def __init__(self, num_layers=15, num_features=64, channels=1):
        super(REDNet30_LR, self).__init__()
        self.num_layers = num_layers
        ...
        self.lr = common.LowRankLayer_dilation(num_features, num_features//2, 5, dilation=3, padding=6, ranks=num_features//16)
...
class REDNet30_NL(nn.Module):
    def __init__(self, num_layers=15, num_features=64, channels=1):
        super(REDNet30_NL, self).__init__()
        self.num_layers = num_layers
        ...
        self.lr = common.NonLocalLayer_dilation(num_features, num_features//2, 5, dilation=3, padding=6, ranks=num_features//16)
